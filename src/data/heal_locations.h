static const struct HealLocation sHealLocations[] =
{
    ...
    [HEAL_LOCATION_PUEBLO_SEBECE - 1] = {MAP_GROUP(PUEBLO_SEBECE), MAP_NUM(PUEBLO_SEBECE), 10, 10},
    [HEAL_LOCATION_COSTA_DITOPLAYA - 1] = {MAP_GROUP(COSTA_DITOPLAYA), MAP_NUM(COSTA_DITOPLAYA), 10, 10},
    [HEAL_LOCATION_CIUDAD_NIAMATINA - 1] = {MAP_GROUP(CIUDAD_NIAMATINA), MAP_NUM(CIUDAD_NIAMATINA), 10, 10},
    [HEAL_LOCATION_CIUDAD_MONROSATE - 1] = {MAP_GROUP(CIUDAD_MONROSATE), MAP_NUM(CIUDAD_MONROSATE), 10, 10},
    [HEAL_LOCATION_PUEBLO_GOCHAMI - 1] = {MAP_GROUP(PUEBLO_GOCHAMI), MAP_NUM(PUEBLO_GOCHAMI), 10, 10},
    [HEAL_LOCATION_CIUDAD_NIONU - 1] = {MAP_GROUP(CIUDAD_NIONU), MAP_NUM(CIUDAD_NIONU), 10, 10},
    [HEAL_LOCATION_VOLCAN_MONROSATE_P1 - 1] = {MAP_GROUP(VOLCAN_MONROSATE_P1), MAP_NUM(VOLCAN_MONROSATE_P1), 10, 10},
};
