...
{
    {MAPSEC_UNDERWATER_105,             MAPSEC_RUTA_15},
    ...
    {MAPSEC_DESIERTO_PALO,      MAPSEC_SOOTOPOLIS_CITY},
    ...
    {MAPSEC_PETALBURG_WOODS,            MAPSEC_RUTA_11},
    ...
    {MAPSEC_ALTERING_CAVE,              MAPSEC_RUTA_12},
    {MAPSEC_ARTISAN_CAVE,               MAPSEC_RUTA_12},
...
static const u16 sTerraOrMarineCaveMapSecIds[ABNORMAL_WEATHER_LOCATIONS] =
{
    ...
    [ABNORMAL_WEATHER_ROUTE_105_NORTH - 1] = MAPSEC_RUTA_15,
    [ABNORMAL_WEATHER_ROUTE_105_SOUTH - 1] = MAPSEC_RUTA_15,
...
{
    [MAPSEC_PUEBLO_SEBECE] = {MAP_GROUP(LITTLEROOT_TOWN), MAP_NUM(LITTLEROOT_TOWN), HEAL_LOCATION_LITTLEROOT_TOWN_BRENDANS_HOUSE_2F},
    [MAPSEC_COSTA_DITOPLAYA] = {MAP_GROUP(OLDALE_TOWN), MAP_NUM(OLDALE_TOWN), HEAL_LOCATION_OLDALE_TOWN},
    [MAPSEC_CIUDAD_NIAMATINA] = {MAP_GROUP(DEWFORD_TOWN), MAP_NUM(DEWFORD_TOWN), HEAL_LOCATION_DEWFORD_TOWN},
    [MAPSEC_CIUDAD_MONROSATE] = {MAP_GROUP(LAVARIDGE_TOWN), MAP_NUM(LAVARIDGE_TOWN), HEAL_LOCATION_LAVARIDGE_TOWN},
    [MAPSEC_PUEBLO_GOCHAMI] = {MAP_GROUP(FALLARBOR_TOWN), MAP_NUM(FALLARBOR_TOWN), HEAL_LOCATION_FALLARBOR_TOWN},
    [MAPSEC_CIUDAD_NIONU] = {MAP_GROUP(VERDANTURF_TOWN), MAP_NUM(VERDANTURF_TOWN), HEAL_LOCATION_VERDANTURF_TOWN},
    ...
    [MAPSEC_RUTA_21] = {MAP_GROUP(ROUTE101), MAP_NUM(ROUTE101), HEAL_LOCATION_NONE},
    [MAPSEC_RUTA_18] = {MAP_GROUP(ROUTE102), MAP_NUM(ROUTE102), HEAL_LOCATION_NONE},
    [MAPSEC_RUTA_12] = {MAP_GROUP(ROUTE103), MAP_NUM(ROUTE103), HEAL_LOCATION_NONE},
    [MAPSEC_RUTA_11] = {MAP_GROUP(ROUTE104), MAP_NUM(ROUTE104), HEAL_LOCATION_NONE},
    [MAPSEC_RUTA_15] = {MAP_GROUP(ROUTE105), MAP_NUM(ROUTE105), HEAL_LOCATION_NONE},
    [MAPSEC_RUTA_14] = {MAP_GROUP(ROUTE106), MAP_NUM(ROUTE106), HEAL_LOCATION_NONE},
...
static void CreateFlyDestIcons(void)
{
    ...
    for (mapSecId = MAPSEC_PUEBLO_SEBECE; mapSecId <= MAPSEC_EVER_GRANDE_CITY; mapSecId++)
    {
