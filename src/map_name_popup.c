...
{
    [MAPSEC_PUEBLO_SEBECE] = MAPPOPUP_THEME_WOOD,
    [MAPSEC_COSTA_DITOPLAYA] = MAPPOPUP_THEME_UNDERWATER,
    [MAPSEC_CIUDAD_NIAMATINA] = MAPPOPUP_THEME_BRICK,
    [MAPSEC_CIUDAD_MONROSATE] = MAPPOPUP_THEME_BRICK,
    [MAPSEC_PUEBLO_GOCHAMI] = MAPPOPUP_THEME_WOOD,
    [MAPSEC_CIUDAD_NIONU] = MAPPOPUP_THEME_UNDERWATER,
    ...
    [MAPSEC_RUTA_21] = MAPPOPUP_THEME_WOOD,
    [MAPSEC_RUTA_18] = MAPPOPUP_THEME_WOOD,
    [MAPSEC_RUTA_12] = MAPPOPUP_THEME_WOOD,
    [MAPSEC_RUTA_11] = MAPPOPUP_THEME_WOOD,
    [MAPSEC_RUTA_15] = MAPPOPUP_THEME_WOOD,
    [MAPSEC_RUTA_14] = MAPPOPUP_THEME_WOOD,
    ...
    [MAPSEC_DESIERTO_PALO] = MAPPOPUP_THEME_STONE2,
    ...
    [MAPSEC_TUNEL_LAVADITO] = MAPPOPUP_THEME_STONE,
    [MAPSEC_ABANDONED_SHIP] = MAPPOPUP_THEME_WOOD,
    [MAPSEC_NEW_MAUVILLE] = MAPPOPUP_THEME_MARBLE,
    [MAPSEC_VOLCAN_MONROSATE] = MAPPOPUP_THEME_STONE,
